 ...
 */
function toHistoricalApiTimestamp(
  date: Date
): string {
  return date
    .toISOString()
              ...
              async (
                ...
                if (
                  ...
                  sendJsonError(
                    res,
                    500,
                    "ODDS_API_KEY ist serverseitig nicht konfiguriert."
                  );
                ...
                try {
                  ...
                  if (
                    ...
                    sendJsonError(
                      res,
                      400,
                      "Der Query-Parameter date fehlt."
                    );
                  ...
                  if (
                    ...
                    sendJsonError(
                      res,
                      400,
                      "Der Query-Parameter date ist ungültig."
                    );
                   ...
                   * 2025-07-01T18:07:00Z
                   */
                  const historicalApiTimestamp =
                    toHistoricalApiTimestamp(
                      parsedDate
                    );
                  ...
                  console.log(
                    "[Historical Odds Proxy] Request:",
                    {
                      ...
                      endpoint:
                        "baseball_mlb historical totals",
                    }
                  );
                  ...
                  console.log(
                    "[Historical Odds Proxy] Response:",
                    {
                      status:
                        upstreamResponse.status,
                  ...
                  console.error(
                    "[Historical Odds Proxy] UPSTREAM ERROR DIAGNOSTIC"
                  );
                  ...
                  sendJsonError(
                    res,
                    502,
                    "Historical Odds Upstream Request fehlgeschlagen. Details siehe Server-Terminal."
                  );
                }
              }
            );
